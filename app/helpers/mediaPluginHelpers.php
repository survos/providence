 ...
 */
   ...
   */
    ...
    {
        if (CompositeCache::contains("mediahelper_imagemagick_installed", "mediaPluginInfo")) {
    ...
    {
        if (CompositeCache::contains("mediahelper_graphicsmagick_installed", "mediaPluginInfo")) {
    ...
    {
        if (CompositeCache::contains("mediahelper_dcraw_installed", "mediaPluginInfo")) {
    ...
    {
        if (CompositeCache::contains("mediahelper_ffmpeg_installed", "mediaPluginInfo")) {
    ...
    {
        if (CompositeCache::contains("mediahelper_ghostscript_installed", "mediaPluginInfo")) {
    ...
    {
        if (CompositeCache::contains("mediahelper_pdftotext_installed", "mediaPluginInfo")) {
    ...
    {
        if (CompositeCache::contains("mediahelper_libreoffice_installed", "mediaPluginInfo")) {
    ...
    {
        if (CompositeCache::contains("mediahelper_mediainfo_installed", "mediaPluginInfo")) {
    ...
    {
        if (CompositeCache::contains("mediahelper_openctm_installed", "mediaPluginInfo")) {
            return CompositeCache::fetch("mediahelper_openctm_installed", "mediaPluginInfo");
        }
        if (!$ps_openctm_ctmconv_path) {
            $ps_openctm_ctmconv_path = caGetExternalApplicationPath('openctm');
        }
    ...
    {
        if (CompositeCache::contains("mediahelper_meshlabserver_installed", "mediaPluginInfo")) {
    ...
    {
        if (CompositeCache::contains("mediahelper_pdfminer_installed", "mediaPluginInfo")) {
            return CompositeCache::fetch("mediahelper_pdfminer_installed", "mediaPluginInfo");
        }
        if (!$ps_pdfminer_path) {
    ...
    {
        if (CompositeCache::contains("mediahelper_wkhtmltopdf_installed", "mediaPluginInfo")) {
    ...
    {
        if (CompositeCache::contains("mediahelper_youtube_dl_installed", "mediaPluginInfo")) {
    ...
    {
        if (CompositeCache::contains("mediahelper_exiftool_installed", "mediaPluginInfo")) {
