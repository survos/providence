                        ...
                        if (preg_match('!'.$vs_regex.'!', $vs_match_name, $va_matches)) {
                            ...
                            switch (strtoupper($ps_match_type)) {
                                case 'STARTS':
                                    ...
                                    if ($o_log) {
                                        $o_log->logDebug(_t("STARTS match on %1 to value %2", $va_matches[1], $ps_value));
                                    }
                                    break;
                                case 'ENDS':
                                    $vb_match = preg_match('!'.$ps_value.'$!i', $va_matches[1], $va_matches);
                                ...
                                case 'CONTAINS':
                                    $vb_match = preg_match('!'.$ps_value.'!i', $va_matches[1], $va_matches);
                                    if ($o_log) {
                                        $o_log->logDebug(_t("CONTAINS match on %1 to value %2", $va_matches[1], $ps_value));
                                    }
                                    break;
                                case 'EXACT':
                                    ...
                                    if ($o_log) {
                                        $o_log->logDebug(_t("EXACT match on %1 to value %2", $va_matches[1], $ps_value));
                                    }
                                    break;
                                ...
                                default:
                                    ...
                                    if ($o_log) {
                                        $o_log->logDebug(_t("Case-insensitive match on %1 to value %2", $va_matches[1], $ps_value));
                                    }
                                    break;
                            }
                            if ($vb_match) {
