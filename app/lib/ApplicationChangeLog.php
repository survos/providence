...
class ApplicationChangeLog
{
     ...
     *
     */
    public function getRecentChangesForDisplay($pn_table_num, $pn_num_seconds=604800, $pn_limit=0, $po_request=null, $ps_css_id=null)
     ...
     *
     */
    public function getRecentChangesAsRawData($pn_table_num, $pn_num_seconds=604800, $pn_limit=0, $return_snapshot=false)
    {	// 604800 = number of seconds in one week
        $o_db = new Db();
        $qs_log = $o_db->prepare("
			SELECT DISTINCT
