...
class TimeExpressionParser
{
    ...
    #	timeFormat
    #
    private function _timeToText($pn_seconds, $pa_options=null)
    {		// pn_seconds is number of seconds since midnight
        if (!$pa_options) {
            $pa_options = array();
        }
    ...
    # -------------------------------------------------------------------
    private function _timerangeToText($pn_start, $pn_end, $pa_options=null)
    { // pn_start and pn_end are both number of seconds since midnight
        if (!$pa_options) {
            $pa_options = array();
        }
        if ($pn_start > $pn_end) {
