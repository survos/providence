    ...
    */
    ...
    public static function setContents($set_code, $options=null)
    {
        ...
        return array_map(function ($r) {
            return ['key' => md5($r['representation_url_large']), 'url' => $r['representation_url_large'], 'media_tag' => $r['representation_tag_large'], 'media_tag_link' => $r['representation_tag_large_as_link'], 'caption' => $r['displayTemplate']];
        }, $reps);
    }
    # ---------------------------------------------------------------
    /**
