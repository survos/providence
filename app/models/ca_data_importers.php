                         ...
                         && strlen(trim($va_mapping_items[$vn_preferred_label_mapping_id]['settings']['skipIfExpression']))
                            ...
                            try {
                                if ($vm_ret = ExpressionParser::evaluate(
                                    $va_mapping_items[$vn_preferred_label_mapping_id]['settings']['skipIfExpression'],
                                ...
                                $o_log->logDebug(_t(
                                    ...
                                    $vs_idno,
                                    $va_mapping_items[$vn_preferred_label_mapping_id]['skipIfExpression'],
                                    $e->getMessage()
                                ));
                            }
                        }
                                        ...
                                        case 'preferred_labels':
                                            if (!$vb_was_preferred_label_match) {
                                                ...
                                                $t_subject->replaceLabel(
                                                    ...
                                                    true,
                                                    ['truncateLongLabels' => $vb_truncate_long_labels, 'displaynameFormat' => $vs_displayname_format]
                                                );
